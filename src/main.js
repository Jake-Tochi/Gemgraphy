...
// --- Base URL helper ---
// Viteのbase設定に対応して、/images/パスを正しいベースパスに変換する
const BASE = import.meta.env.BASE_URL; // e.g., '/Gemgraphy/'
function resolveHtml(html) {
  // src="/images/ と url('/images/ のパスを修正
  return html
...
function renderPage() {
  ...
  if (contentEl) {
    ...
    contentEl.innerHTML = resolveHtml(renderFn(translations));
