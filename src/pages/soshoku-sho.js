...
export function renderSoshokuSho(t) {
  ...
  return `
    ...
    <section class="hero hero--page">
      <div class="hero__bg" style="background-image: url('/images/calligraphy-elegant.jpg');"></div>
    ...
    <section class="photo-break fade-in">
      <div class="photo-break__image">
        <img src="/images/calligraphy-gold.jpg" alt="装飾書の世界" loading="lazy" />
      </div>
    </section>
      ...
      <div class="container">
        <div class="content-block fade-in">
          <div class="content-block__image">
            <img src="/images/jewelry-artwork.jpg" alt="Gemgraphy" loading="lazy" />
          </div>
    ...
    <section class="section">
      <div class="container">
        <div class="content-block content-block--reverse fade-in">
          <div class="content-block__image">
            <img src="/images/beadsgraphy-complex.jpg" alt="Beadsgraphy" loading="lazy" />
          </div>
          <div class="content-block__text">
    ...
    <section class="photo-break fade-in">
      <div class="photo-break__image">
        <img src="/images/calligraphy-frame.jpg" alt="光と素材" loading="lazy" />
      </div>
    </section>
