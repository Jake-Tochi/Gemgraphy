...
export function renderGemgraphy(t) {
  ...
  return `
    ...
    <section class="hero hero--page">
      <div class="hero__bg" style="background-image: url('/images/jewelry-dark.jpg');"></div>
    ...
    <section class="photo-break fade-in">
      <div class="photo-break__image">
        <img src="/images/calligraphy-yume.jpg" alt="Gemgraphy" loading="lazy" />
      </div>
    </section>
      ...
      <div class="container">
        <div class="content-block fade-in">
          <div class="content-block__image">
            <img src="/images/pearls-white.jpg" alt="素材と表現" loading="lazy" />
          </div>
    ...
    <section class="photo-break fade-in">
      <div class="photo-break__image">
        <img src="/images/calligraphy-hikari.jpg" alt="制作" loading="lazy" />
      </div>
    </section>
