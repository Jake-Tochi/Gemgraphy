...
export function renderBeadsgraphy(t) {
  ...
  return `
    ...
    <section class="hero hero--page">
      <div class="hero__bg" style="background-image: url('/images/beadsgraphy-dark.jpg');"></div>
    ...
    <section class="photo-break fade-in">
      <div class="photo-break__image">
        <img src="/images/calligraphy-bold.jpg" alt="Beadsgraphy" loading="lazy" />
      </div>
    </section>
    ...
    <section class="photo-break fade-in">
      <div class="photo-break__image">
        <img src="/images/beadsgraphy-abstract.jpg" alt="制作の風景" loading="lazy" />
      </div>
    </section>
